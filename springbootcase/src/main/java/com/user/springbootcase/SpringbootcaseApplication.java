...
//  notlar
// Swagger tamam
// Token oluşturmada sorun yok ama kontrol ederken problem var detaylı incele	
	...
	public OpenAPI customOpenAPI(@Value("not: "
		...
		return new OpenAPI()
				...
				.license(new License().name("Usercase Api Licence")));	
	}
...
//                .select()
//                .apis(RequestHandlerSelectors.basePackage("com.user.springbootcase.api.controllers"))
